...
base_path = '/home/duzx16/data/{0}/minerva'.format(dataset_name)
...
def check_for_reversible_relations(rel_to_tuple, threshold=0.80):
    ...
    for i, rel1 in enumerate(rel_to_tuple):
        ...
        for rel2 in rel_to_tuple:
            ...
            if rel1 == 'concept:teamcoach' and rel2 == 'concept:athleteledsportsteam_inv':
                print(left, right)
...
rel2reversal_rel, banned_pairs = check_for_reversible_relations(rel2tuple_train, threshold)
...
if evaluate:
    all_cases = []
    rel2tuples = {}
    train_dev = test_cases['train.txt'] + test_cases['dev.txt']
    ...
    print(rel2tuples['concept:teamcoach'])
